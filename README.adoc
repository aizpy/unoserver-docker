...
[source,bash]
----
docker run -it -v <your directory>:/data/ ghcr.io/aizpy/unoserver-docker
----
...
[source,bash]
----
docker run -it -v <your directory>:/data/ ghcr.io/aizpy/unoserver-docker unoconvert /data/document.docx /data/document.pdf
----
...
[source,bash]
----
docker run -p 2003:2003 ghcr.io/aizpy/unoserver-docker
----
